...
*Notes:*  
"multiple structures" is TRUE when multiple factor structures were identified in the EFA. The most common structure was used in the CFA. See Appendix for all structures.  
...
for(n in 1:m){
  ...
  cat("Note: loadings flagged when <", load.flag)
  cat("\n\n")
  if(n > 1){
